package com.rui.retrofit2.di;


import android.content.res.AssetManager;

import com.rui.retrofit2.PropertiesManager;
import com.rui.retrofit2.interceptor.AuthenticationInterceptor;
import com.rui.retrofit2.interceptor.BaseUrlInterceptor;
...
//    @ForTestingPurposes
    ...
    @Provides
    @Singleton
    static PropertiesManager providesPropertyManager(AssetManager assetManager, @Named("debug")boolean isDebug) {
        return new PropertiesManager(assetManager, isDebug);
    }
