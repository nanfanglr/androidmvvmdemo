...
public class ImageLoader {
    ...
    private static RequestOptions getDefualtOption() {
        return getOption(R.drawable.img_loading, R.drawable.error, R.drawable.default_img, 0 + "");
    }
    ...
    private static RequestOptions getOption(
            ...
            , @DrawableRes int nullDrawable, String timeStamp) {
...
//                .centerCrop()
     ...
     */
    public static void displayImage(Context context, String url, ImageView imageView, String timeStamp) {
        displayImageBase(context, url, imageView,
                getOption(R.drawable.img_loading, R.drawable.error, R.drawable.default_img, timeStamp));
        ;
    }
    ...
    public static void displayImage(Context context, String url, ImageView imageView
        ...
        displayImageBase(context, url, imageView, getOption(loadingDrawable, errorDrawable, nullDrawable, 0 + ""));
    }
    ...
    private static RequestOptions getOption(@DrawableRes int loadingDrawable) {
        return getOption(loadingDrawable, R.drawable.error, R.drawable.img_loading, 0 + "");
    }
